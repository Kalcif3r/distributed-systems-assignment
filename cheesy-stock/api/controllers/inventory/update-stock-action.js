module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    let invoiceItems = JSON.parse(inputs.invoiceItems)
    console.log('inputs recieved are : ',invoiceItems)

    // NOTE: You have to take care of fakeObject and replace it with the right attrib from inputs
